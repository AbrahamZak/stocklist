  ...
  const getStockData = async(ticker) => {
    ...
    const stockSentiment = await fetch(
      ...
      setBasicInfo({
        ...
        change: (((stockDailyJSON.c - stockDailyJSON.pc)/stockDailyJSON.c)*100).toFixed(2),
  ...
  try{
    ...
    try{
      setNewsSentiment({
        ...
        sectorAverageBullishPercent: (stockSentimentJSON.sectorAverageBullishPercent),
        bearishPercent: stockSentimentJSON.sentiment.bearishPercent,
        sectorAverageBearishPercent: (1 - stockSentimentJSON.sectorAverageBullishPercent)
      });
    }
    catch(err){
